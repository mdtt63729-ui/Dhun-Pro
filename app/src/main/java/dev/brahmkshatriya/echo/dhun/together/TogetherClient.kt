...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: dev.brahmkshatriya.echo.dhun.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: dev.brahmkshatriya.echo.dhun.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is dev.brahmkshatriya.echo.dhun.together.JoinDecision -> {

...
import dev.brahmkshatriya.echo.dhun.ui.component.MediaMetadataListItem
import dev.brahmkshatriya.echo.dhun.ui.menu.PlayerMenu
import dev.brahmkshatriya.echo.dhun.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is dev.brahmkshatriya.echo.dhun.together.TogetherSessionState.Joined &&
                (togetherSessionState as dev.brahmkshatriya.echo.dhun.together.TogetherSessionState.Joined).role is dev.brahmkshatriya.echo.dhun.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? dev.brahmkshatriya.echo.dhun.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is dev.brahmkshatriya.echo.dhun.together.TogetherRole.Guest
                                                                if (isGuest) {
